define([
		...
		null,
	{
		...
		constructor: function(/*Object*/params, /*DOMNode*/node){
			...
			//console.log("smdnd.Moveable ::: constructor");
		...
		isFormElement: function(/*DOMEvent*/ e){
			...
			//console.log("smdnd.Moveable ::: isFormElement");
			var t = e.target;
		...
		onMouseDown: function(/*DOMEvent*/e){
			...
			//console.log("smdnd.Moveable ::: onMouseDown");
		...
		onFirstMove: function(/*DOMEvent*/e){
			...
			//console.log("smdnd.Moveable ::: onFirstMove");
			event.stop(e);
		...
		initOffsetDrag: function(/*DOMEvent*/e){
			...
			//console.log("smdnd.Moveable ::: initOffsetDrag");
		...
		onMove: function(/*DOMEvent*/e){
			...
			//console.log("smdnd.Moveable ::: onMove");
			event.stop(e);
		...
		destroy: function(){
			...
			// console.log("smdnd.Moveable ::: destroy");
